...
:root {
    ...
    --primary-dark: #059669;
    --bg-color: #ecfdf5; /* Light Emerald Background */
    --text-dark: #0f172a;
    --text-gray: #64748b;
}
...
.logo-icon { 
    background: #10b981; color: white; width: 45px; height: 45px; 
    border-radius: 12px; display: flex; align-items: center; justify-content: center; font-size: 24px;
    box-shadow: 0 4px 6px -1px rgba(16, 185, 129, 0.4);
}
.brand-header h1 { font-size: 24px; font-weight: 800; color: #0f172a; margin: 0; letter-spacing: -0.5px; }
...
.card-header h3 { margin: 0; color: #0f172a; font-size: 20px; font-weight: 700; }
.card-header p { color: #64748b; font-size: 14px; margin-top: 5px; }

/* ALERT ERROR */
.alert-error {
    background-color: #fef2f2; color: #ef4444; padding: 12px; border-radius: 8px;
...
.form-group label { display: block; margin-bottom: 8px; color: #334155; font-weight: 600; font-size: 13px; }

.input-wrapper { position: relative; }
.input-icon { position: absolute; left: 12px; top: 50%; transform: translateY(-50%); font-size: 16px; opacity: 0.7; }

.form-group input {
    width: 100%; padding: 12px 12px 12px 40px; /* Padding kiri buat icon */
    border: 1px solid #cbd5e1; border-radius: 10px; box-sizing: border-box;
    font-size: 14px; transition: all 0.3s; background: #f8fafc; color: #0f172a;
}

.form-group input:focus {
    border-color: #10b981; background: white; outline: none;
    box-shadow: 0 0 0 3px rgba(16, 185, 129, 0.1);
}

.forgot-pass { text-align: right; margin-bottom: 20px; }
.forgot-pass a { color: #10b981; font-size: 12px; text-decoration: none; font-weight: 600; }
.forgot-pass a:hover { text-decoration: underline; }

/* BUTTON */
.btn-login {
    width: 100%; padding: 14px;
    background-color: #10b981; color: white; border: none; border-radius: 10px;
...
.btn-login:disabled { background-color: #94a3b8; cursor: not-allowed; transform: none; box-shadow: none; }

.login-footer { margin-top: 30px; text-align: center; color: #94a3b8; font-size: 12px; border-top: 1px solid #f1f5f9; padding-top: 20px; }
</style>